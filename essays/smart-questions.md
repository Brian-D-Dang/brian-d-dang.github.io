...
labels:
  ...
  - StackOverflow
---
<img width="500px" class="rounded float-start pe-4" src="../img/smart-questions/stackOverflow.png">
...
An example of such a bad question can be found below: **(source: [Bad Question](https://stackoverflow.com/q/75254842))**
<img width="700px" class="rounded float-start pe-4" src="../img/smart-questions/badQuestion1.png">
...
An example of smart question can be seen below: **(source: [Smart Question](https://stackoverflow.com/q/11227809))**
...
<div class="text-center p-4">
  <img width="450px" 
       ...
       class="img-thumbnail" >
  <img width="450px" 
       src="../img/smart-questions/goodQuestion2.png" 
       class="img-thumbnail" >
  <img width="450px" 
